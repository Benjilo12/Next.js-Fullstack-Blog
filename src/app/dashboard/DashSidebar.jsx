      ...
      <div className="p-4 space-y-2">
            ...
            >
              ...
              <div className="flex-1 flex items-center justify-between min-w-0">
                ...
                {item.badge && (
                  <span
                    className={`
                      text-xs font-bold px-2 py-1 rounded-full border shrink-0 ml-2
                      ${
                        item.active
        ...
        <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
          <SignOutButton redirectUrl="/">
            <button className="w-full group flex items-center gap-4 p-4 rounded-xl hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-200 cursor-pointer border-2 border-transparent hover:border-red-200 dark:hover:border-red-800">
