...
export default function HeroSection() {
  return (
    <>
      <div className="relative mx-auto flex min-h-[screen] max-w-7xl  mt-12 md:mt-13 flex-col overflow-hidden px-4 pt-16 sm:px-6 sm:pt-20 md:pt-24 lg:px-8 lg:pt-32 xl:pt-40  ">
        <div>
